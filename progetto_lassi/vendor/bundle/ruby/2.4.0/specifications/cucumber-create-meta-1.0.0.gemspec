# -*- encoding: utf-8 -*-
# stub: cucumber-create-meta 1.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-create-meta-1.0.0".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["~> 12.2", ">= 12.2.0"])
    ...
    s.add_dependency(%q<cucumber-messages>.freeze, ["~> 12.2", ">= 12.2.0"])
