# -*- encoding: utf-8 -*-
# stub: cucumber-core 7.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-core-7.1.0".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<rubocop>.freeze, [">= 0.78.0", "~> 0.78"])
    ...
    s.add_dependency(%q<rubocop>.freeze, [">= 0.78.0", "~> 0.78"])
