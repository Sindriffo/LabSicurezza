# -*- encoding: utf-8 -*-
# stub: cucumber-html-formatter 7.2.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "cucumber-html-formatter-7.2.0".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["~> 12.4", ">= 12.4.0"])
    s.add_development_dependency(%q<rake>.freeze, ["~> 13.0", ">= 13.0.1"])
    s.add_development_dependency(%q<rspec>.freeze, ["~> 3.9", ">= 3.9.0"])
  else
    s.add_dependency(%q<cucumber-messages>.freeze, ["~> 12.4", ">= 12.4.0"])
